        ...
        <div id="left-side-form">
            ...
            <div className="data-form-flex input-gap-bottom">
                ...
                <div>
                    <label>Available From</label><br/>
                       <input type="date" className="date-input" name="avalableFrom" onChange={(e)=>setEdit({...edit,avalableFrom:e.target.value})} value={edit.avalableFrom} min={"2024-01-10"}/>
                   </div>
                        
                   <div>
                   <label>Available Till</label><br/>
                       <input type="date" className="date-input" name="availableTill" onChange={(e)=>setEdit({...edit,availableTill:e.target.value})} value={edit.availableTill} max={"2024-01-20"} />                    
                   </div>
                </div>
          ...
          { file? <div id="imgs-add-car-container">
                 ...
                 <div className="img-sort-box">
                    <img src={file} id="preview-img-of-the-file" alt="preview" ></img>
                 </div>
                   ...
                   <div className="img-sort-box">
                      ...
                      <img src={`https://car-rental-app-server.onrender.com/cars/${edit.image}`} id="preview-img-of-the-file" alt="preview"></img>
